...
<div id='reflection-collapsible'>
	...
	<div class='popup-content'>
		<p>Enter what went right about this project into the editor below.</p>
		<hr>
		...
		<form data-ajax = 'false' method='POST' action='controllers/AchieveModController.php'>
			<input style = 'display:none' name = 'controller-type' value = 'WhatWentRight'>
			<textarea name = 'new-value'id="wysihtml5-textarea" placeholder='<?php echo htmlspecialchars( ($stage->what_went_right)?$stage->what_went_right:'', ENT_QUOTES )?>'
				></textarea>
