...
<div id='reflection-collapsible'>
	...
	<div class='popup-content'>
		<p>Enter "What can be changed" for future projects into the editor below.</p>
		<hr>
		...
		<form data-ajax = 'false' method='POST' action='controllers/AchieveModController.php'>
			<input style = 'display:none' name = 'controller-type' value = 'WhatCanBeChangedInTheFuture'>
			<textarea name = 'new-value'id="wysihtml5-textarea" placeholder='<?php echo htmlspecialchars(($stage->what_went_right)?$stage->future_changes:'', ENT_QUOTES )?>'
				></textarea>
