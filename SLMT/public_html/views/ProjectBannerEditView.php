...
if (isset($_GET['new'])) {
	$banner = ORM::for_table ( 'project_banner' )->create();

	$banner->project_id = $id;

	$banner->save();

} else if (isset($_GET['bid'])) {
	$bid = $_GET ['bid'];
	$banner = ORM::for_table ( 'project_banner' )->find_one ( $bid );
} else {
?>
	<script>
...
<div class='banner-edit-view'>
	...
	<div class='popup-content'>
		<form data-ajax='false' method="post" enctype="multipart/form-data" action = 'controllers/ProjectBannerEditController.php?project_id=<?php echo $id; ?>'>
			<table>
				<tr>
					<td>
						Choose a Banner:
