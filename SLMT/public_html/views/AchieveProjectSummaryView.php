...
<div id='reflection-collapsible'>
	<div class='popup-heading' data-theme='g'>
	...
	<div class='popup-content'>
		<p>Enter a Summary of Project Achievements in the editor below.</p>
		<hr>
		...
		<form data-ajax = 'false' method='POST' action='controllers/AchieveModController.php'>
			<input style = 'display:none' name = 'controller-type' value = 'ProjectAchievementsSummary'>
			<textarea name = 'new-value'id="wysihtml5-textarea" placeholder='<?php echo htmlspecialchars(($stage->projects_achievements_summary)?$stage->projects_achievements_summary:'',ENT_QUOTES )?>'></textarea>
